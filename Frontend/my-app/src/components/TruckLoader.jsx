      ...
      <div className="truckWrapper">
        <div className="truckBody">
          ...
          >
            ...
            <path strokeWidth="2" stroke="#282828" fill="#282828"
        ...
        <div className="truckTires">
          {[1, 2].map((_, i) => (
            <svg key={i} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 30 30" className="tiresvg">
...
c0-5.478-0.856-10.872-2.506-16.017h9.992c0-9.354-19.352-17.204-45.463-19.366v-8.954h-6.149C200.189,38.779,223.924,16,252.882,16z" />
        </svg>
      </div>
    </div>
  );
